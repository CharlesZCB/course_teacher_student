...
<img alt="" src="/images/${user.filename }" style="width: 50px;height: 50px;" class="img-thumbnail">
</td>
</tr>
...
<tr>
<td>
<img alt="" src="${path }/static/image/teacherperson/class.png">&nbsp;
年级</td>
<td>${user.nianji }级</td>
</tr>
<tr>
<td>
<img alt="" src="${path }/static/image/teacherperson/classnum.png">&nbsp;
班级</td>
<td>${user.banming }(${user.banhao})</td>
</tr>
<tr>
<td>
...
生日</td>
<td>
<fmt:formatDate value="${user.birth }" pattern="yyyy-MM-dd"/></td>
</tr>
<tr>
<td>
