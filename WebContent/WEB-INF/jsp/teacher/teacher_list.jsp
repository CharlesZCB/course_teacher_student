...
<nav aria-label="Page navigation">
  <ul class="pagination">
   <li><a href="${path }/teaches/allteacher?pn=1">首页</a></li>
   <c:if test="${pageInfo.hasPreviousPage }">
    <li>
      <a href="${path }/teaches/allteacher??pn=${pageInfo.pageNum-1 }" aria-label="Previous">
  ...
  <c:forEach items="${pageInfo.navigatepageNums }" var="pagenum">
    ...
    <li  class="active"><a href="#">${pagenum }</a></li>
     ...
     <c:if test="${pagenum!=pageInfo.pageNum }">
    <li><a href="${path }/teaches/allteacher?pn=${pagenum }">${pagenum }</a></li>
    </c:if>
    </c:forEach>
    <c:if test="${pageInfo.hasNextPage }">
   <li>
      <a href="${path }/teaches/allteacher?pn=${pageInfo.pageNum+1 }" aria-label="Next">
     ...
     <li><a href="${path }/teaches/allteacher?pn=${pageInfo.pages }">尾页</a></li>
  </ul>
</nav>
</div>
</div>
